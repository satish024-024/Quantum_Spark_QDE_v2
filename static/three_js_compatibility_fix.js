 ...
 * Fixes all reported THREE.js compatibility issues including:
 * - Missing THREE.Math methods (deprecated in r150+)
 * - CSS2DRenderer compatibility
 * - Object extensibility issues
 * - Bloch Sphere specific fixes
 */
    ...
    function setupMathCompatibility() {
        ...
        if (!THREE.Float) {
            try {
                ...
                console.warn('Could not add Float utility:', e);
            }
        }
    }
